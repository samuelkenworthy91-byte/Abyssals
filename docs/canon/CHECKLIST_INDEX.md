...
|---|---|---|
| 01 | Exact Stat Growth Algorithm | Seeded FE-style independent growth; BST-weighted formula; +10 HP per successful increment only; evolution-history-safe growth. |
...
| 09 | Leader & Trainer Fate System | Eight-leader SPARE/EXECUTE; Samiel surrender exception; 18 execution proxies; Hell returns; v1.1 with v1.2 restoration correction. |
...
| 11 | Evolution Validation | 187 species / 98 paths; only four story-choice families main-game branch locked; opposite branch postgame via Primeval Reach/approved resolver. |
...
| 13 | Battle Edge Cases | 42 locked edge-case behaviours; simultaneous KOs; reserve-dependent mutual-KO victory; delegates starter-life exactness to 14 and crash persistence to 15. |
...
The row summaries are implementation indexes, not permission to ignore the detailed active canon in this canon directory and machine-readable files.


All 17 detailed checklist topics are recovered. The 35 reference files are preserved under docs/source_archive/canon_sources/ and losslessly searchable under data/reference/. The 685 indexed table contracts retain original wording as evidence; apply supersessions before execution. Exact remaining questions are in ../audit/UNRESOLVED_ITEMS.md.
